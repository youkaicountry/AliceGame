...
//MUTATES THIS DNA
void DNA::mutate(double chance, double severity, int rlock, double jostle)
{
   int i = 0;
   ...
   for (i = 0;i < 3;i++)
   {
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {ebulletattract[i] += (10*severity-ra.nextDouble(10*severity*2));}else{ebulletattract[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {ebulletattractpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{ebulletattractpower[i]=ra.nextDouble(1.0)*80 - 40;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {ebulletrepel[i] += (10*severity-ra.nextDouble(10*severity*2));}else{ebulletrepel[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {ebulletrepelpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{ebulletrepelpower[i]=ra.nextDouble(1.0)*80 - 40;}}
   ...
   for (i = 0;i < 3;i++)
   {
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {powerupattract[i] += (10*severity-ra.nextDouble(10*severity*2));}else{powerupattract[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {powerupattractpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{powerupattractpower[i]=ra.nextDouble(1.0)*80 - 40;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {poweruprepel[i] += (10*severity-ra.nextDouble(10*severity*2));}else{poweruprepel[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {poweruprepelpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{poweruprepelpower[i]=ra.nextDouble(1.0)*80 - 40;}}
   ...
   for (i = 0;i < 3;i++)
   {
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {elineattract[i] += (10*severity-ra.nextDouble(10*severity*2));}else{elineattract[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {elineattractpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{elineattractpower[i]=ra.nextDouble(1.0)*80 - 40;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {elinerepel[i] += (10*severity-ra.nextDouble(10*severity*2));}else{elinerepel[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {elinerepelpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{elinerepelpower[i]=ra.nextDouble(1.0)*80 - 40;}}
   ...
   for (i = 0;i < 3;i++)
   {
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {wlineattract[i] += (10*severity-ra.nextDouble(10*severity*2));}else{wlineattract[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {wlineattractpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{wlineattractpower[i]=ra.nextDouble(1.0)*80 - 40;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {wlinerepel[i] += (10*severity-ra.nextDouble(10*severity*2));}else{wlinerepel[i]=ra.nextDouble(1.0)*100000;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {wlinerepelpower[i] += (.05*severity-ra.nextDouble(.05*severity*2));}else{wlinerepelpower[i]=ra.nextDouble(1.0)*80 - 40;}}
      ...
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {bulletpanic += (.01*severity-ra.nextDouble(10*severity*2));}else{bulletpanic=ra.nextDouble(1.0)*30;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {reactioncycles += ((int)(2*severity-ra.nextDouble(severity*4)));}else{reactioncycles=ra.nextInt(6)+1;}}
      
      for (i = 0;i<3;i++)
      {
         if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {bulletsee[i] += (.2*severity-ra.nextDouble(10*severity*2));}else{bulletsee[i]=ra.nextDouble(1.0)*500;}}
         if (bulletsee[i] <= 0) {bulletsee[i] = .0001;}
      }
      
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {carefulzone += (.1*severity-ra.nextDouble(.05*severity*2));}else{carefulzone=ra.nextDouble(1.0)*80;}}
      if (ra.nextDouble(1.0) < chance) {if (ra.nextDouble(1.0) < jostle) {gameline += (.007*severity-ra.nextDouble(.05*severity*2));}else{gameline=ra.nextDouble(1.0)*.75+.2;}}
